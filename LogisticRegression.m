function [theta_log] = LogisticRegression(spreadsheet, workbook, X, Y, alpha, num_iters, lambda)
    % Import Data %
    pkg load io
...
%% NOT WRITTEN BY ME; TAKEN FROM COURSERA STANFORD MACHINE LEARNING COURSE %%
